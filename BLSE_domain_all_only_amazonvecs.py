...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--predictions_dir', help="directory to write predictions", default='predictions/ONLY_AMAZON_VECS/')
    parser.add_argument('-savedir', default='models/ONLY_AMAZON_VECS/', help="where to dump weights during training (default: ./models/ONLY_AMAZON_VECS)")
    ...
    data =  [('semeval_2016', semeval_2016, 'embeddings/twitter_embeddings.txt'),
             ...
             ('books', books, 'embeddings/amazon-sg-300.txt'),
